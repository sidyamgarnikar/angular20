...
export class AppComponent {
  ...
  foods: Array<string> = ["Pizza", "Burger", "Pasta"];
  drinks: Array<string> = ["Tea", "Coffee", "Juice"];
  flowers: Array<string> = ["Rose", "Lily", "Tulip"]
  planets: Array<string> = ["Earth", "Mars", "Venus"];
  browsers: Array<string> = ["Chrome", "Firefox", "Edge"];
  companies: Array<string> = ["Google", "Microsoft", "Amazon"];
